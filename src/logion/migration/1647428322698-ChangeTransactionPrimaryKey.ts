...
export class ChangeTransactionPrimaryKey1647428322698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "PK_transaction" PRIMARY KEY ("block_number", "extrinsic_index", "id")`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "PK_transaction"`);
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "PK_transaction" PRIMARY KEY ("extrinsic_index", "id")`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "PK_transaction"`);
