...
export class AddBallot1673968386608 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vote" ADD "status" character varying NOT NULL DEFAULT 'PENDING'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vote" DROP COLUMN "status"`);
